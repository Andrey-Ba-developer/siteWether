...
form.onsubmit = async function (e) {
	...
	if (data.error) {
		...
		const images = [
			...
			{ range: [0, 8], url: "./img/women_icons/autumn.png" },
			{ range: [8, 12], url: "./img/women_icons/autumn2.png" },
			{ range: [12, 16], url: "./img/women_icons/heat.png" },
			{ range: [12, 16], url: "./img/women_icons/heat2.png" },
			{ range: [12, 16], url: "./img/women_icons/sunny.png" },
			{ range: [12, 20], url: "./img/women_icons/sunny2.png" },
